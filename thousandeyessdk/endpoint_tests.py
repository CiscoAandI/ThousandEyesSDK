...
class EndpointTest(BaseEntity):
    ...
    def get_detailed_path_trace(self, agent_id, interval):
        ...
        Request
            ...
            {roundId} the round ID for which you wish to obtain data. Equals the beginning
            of the testing round, in epoch time format.
            There is no request body for this request.
        Response
            Each route should start with a hop of 1
            Where a hop number is missing from response data, this is an indication that a
            star (*) response was returned in the path trace attempt for that hop.
        """
