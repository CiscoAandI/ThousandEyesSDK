...
class Alert(BaseEntity):
    ...
    @property
    def monitors(self):
        """This is property to get array of monitors where the alert has at some point been
        active since the point that the alert was triggered. Only shown on BGP alerts.
